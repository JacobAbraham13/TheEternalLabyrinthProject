...
namespace EternalLabyrinth
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        //GameState Enums
        public enum GameState { START, LEVEL1, LEVEL2, LEVEL3, END };
           ...
           // UIElements.Begin();
            ...
            switch (gState)
            {
                ...
                case GameState.END:
                    ...
                    UIElements.Draw(backgroundText, new Rectangle(0, 0, 800, 600), Color.White);
                    UIElements.DrawString(largerFont, "YOU HAVE DIED!", new Vector2(175, 55), Color.Red);
                    UIElements.DrawString(largerFont, "GAME OVER", new Vector2(250, 200), Color.Red);
                    UIElements.DrawString(largerFont, "Press R to Play Again", new Vector2(85, 400), Color.Orange);
